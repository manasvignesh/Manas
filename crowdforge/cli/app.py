...
from crowdforge import __version__
from crowdforge.analytics.export import export_result
...
from crowdforge.utils.config import AppConfig, default_database_path, home_dir, load_config, save_config

app = typer.Typer(no_args_is_help=False, help="CrowdForge - synthetic society simulator.")
console = Console()
...
def root(ctx: typer.Context) -> None:
    ...
    if ctx.invoked_subcommand is None:
        from crowdforge.cli.tui import CrowdForgeApp
        CrowdForgeApp().run()
